...
country = {
	...
	INVESTMENT_SCORE_FACTOR = 0.0005, -- how much foreign investment money counts towards your industry score
	...
	TECH_YEAR_SPAN = 150,
	TECH_FACTOR_VASSAL = 0.66, -- cost reduction factor if overlord has research the tech
	MAX_SUPPRESSION = 100,
