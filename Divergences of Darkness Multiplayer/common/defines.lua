...
country = {
	...
	CAMPAIGN_EVENT_STATE_SCALE = -1,	-- every non-colonial state reduces by 3 days.
	...
	COLONIZATION_RELEASE_DOMINION_COST = 50,
...
economy = {
	...
	MAX_LOAN_CAP_FROM_BANKS = 33, -- can loan max % of country tax base from single country
...
ai =
{
	...
	NAVAL_SUPPLY_PENALTY_LIMIT = 0.8, -- AI will allow to have max X% of supply penalty (when too little naval bases)
	...
	PEACE_TIME_FACTOR_NO_GOALS = 1.0, -- this extra time factor is applied after PEACE_TIME_FACTOR if we ahve no wargoals
	...
	AGGRESSION_BASE = 12, -- general AI aggression
