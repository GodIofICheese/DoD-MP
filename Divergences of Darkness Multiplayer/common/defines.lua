...
economy = {
	...
	BANKRUPCY_DURATION = 4, -- Years till a bankruptcy clears all loans
...
pops = {
	...
	INVENTION_IMPACT_ON_DEMAND = 0.0020, -- how much each invention in a country increases demand for a product in percent
...
ai =
{
	...
	PEACE_TIME_MONTHS = 36, -- months of additional AI stubbornness in a war
	...
	PEACE_WAR_DIRECTION_WINNING_MULT = 4.0, -- Multiplies AI emphasis on war direction if it's the one making gains
	PEACE_FORCE_BALANCE_FACTOR = 1.0, -- AI willingness to peace based on strength estimation of both sides
