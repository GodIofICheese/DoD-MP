...
country = {
	...
	CAMPAIGN_EVENT_BASE_TIME = 160, -- Roughly twice per campaign. Used to be 42 - once every 6 weeks.
	CAMPAIGN_EVENT_MIN_TIME = 42 ,-- never more often than 3 weeks between
	...
	AI_SUPPORT_REFORM = 0.04, -- At least this many % needs to support a reform for the AI to take it
	...
	UNCIV_TECH_SPREAD_MIN = 0.60, --Minimum techs an unciv will get on westernizing
...
economy = {
	...
	MAX_LOAN_CAP_FROM_BANKS = 50, -- can loan max % of country tax base from single country
	...
	BANKRUPCY_DURATION = 0, -- Years till a bankruptcy clears all loans
...
military = {
	...
	COMBATLOSS_WAR_EXHAUSTION = 12, -- base war exhaustion in combat
...
diplomacy = {
	...
	RELATION_INFLUENCE_MODIFIER = 500, -- divisor for relation
	...
	GW_WARSCORE_COST_MOD = 0.33, -- cost reduction factor on warscore needed to fulfill goal if great war
	...
	TENSION_FROM_MOVEMENT_MAX = 2.4, -- max total value no matter the size of the movement
	...
	TWS_FULFILLED_SPEED = 0.025, -- Ticking War Score grows up with this speed daily once CB is fulfilled
	TWS_NOT_FULFILLED_SPEED = 0.025, -- Ticking War Score falls down when CB is not fulfilled (or after grace period)
	...
	TWS_BATTLE_MIN_COUNT = 40, -- At least X battles before the aspect of wins will count
	TWS_BATTLE_MAX_ASPECT = 64.0, -- Max allowed battle wins aspect for TWS
...
pops = {
	...
	INVENTION_IMPACT_ON_DEMAND = 0.0025, -- how much each invention in a country increases demand for a product in percent
...
ai =
{
	...
	AGGRESSION_BASE = 36, -- general AI aggression
	AGGRESSION_UNCIV_BONUS = 40, -- additional AI civ aggression against uncivs
